...
Handlebars.registerHelper('safeHTML', function(string) {
...
Handlebars.registerHelper("itemNumber", function (start, index) {
    return (start + parseInt(index) + 1);
